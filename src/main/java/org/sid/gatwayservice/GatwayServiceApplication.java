...
public class GatwayServiceApplication {
	...
	//@Bean // a la place de ficher YML // configuration statics des routes
	...
	@Bean
		// moi je connais pas les routes mais a chaque fois que tu reçoit la request regarde l'url de microservice
